...
def theory(args):
    num_agebrackets, ages, seed_num, initial_infected_age, lambda1, lambda2, r, M, H, t_max, game_t_max, x0_ABCD_list, G_A_percentage_list, G_B, G_C, G_D, beta = args
    R_GD_list = []
    R_A_GD_list = []
    R_B_GD_list = []
    R_C_GD_list = []
    ...
    for G_A in tqdm(G_A_percentage_list):
        game_t = 1
        i = 0
        label = 0
        # 初始化--设置初始接种
