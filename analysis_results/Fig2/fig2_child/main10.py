...
G_B_percentage_list_all=np.linspace(0,1,20)
G_B_percentage_list=G_B_percentage_list_all[18:20]
G_C_percentage=0.8
G_D_percentage=0.2
...
if __name__ == '__main__':
    ...
    for beta in beta_list:
          args = []
          args.append([num_agebrackets, ages, seed_num, initial_infected_age, lambda1, lambda2, r, M, H, t_max, game_t_max, x0_ABCD_list, G_A_percentage, G_B_percentage_list, G_C_percentage, G_D_percentage, beta])
